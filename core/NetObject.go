 ...
 */
    ...
    const NetObject_UDP = "udp";
    const NetObject_TCP = "tcp";
    const NetObject_TRANSPORT = "transport";
    const NetObject_METHOD = "method";
    const NetObject_USER = "user";
    const NetObject_PHONE = "phone";
    const NetObject_MADDR = "maddr";
    const NetObject_TTL = "ttl";
    const NetObject_LR = "lr";
    const NetObject_SIP = "sip";
    const NetObject_SIPS = "sips"; 
    const NetObject_TEL = "tel";
    const NetObject_POSTDIAL  =  "postdial";
    const NetObject_PHONE_CONTEXT_TAG  = "context-tag";
    const NetObject_ISUB 	  = "isub";
    const NetObject_PROVIDER_TAG    = "provider-tag";
